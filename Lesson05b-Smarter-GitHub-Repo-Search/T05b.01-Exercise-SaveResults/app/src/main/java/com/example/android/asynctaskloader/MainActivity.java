...
public class MainActivity extends AppCompatActivity {
    ...
    private static final String SEARCH_RESYLTS_RAW_JSON = "results";
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        if (savedInstanceState != null) {
            String queryUrl = savedInstanceState.getString(SEARCH_QUERY_URL_KEY);
            String rawJsonSearchResults = savedInstanceState.getString(SEARCH_RESYLTS_RAW_JSON);
    ...
    protected void onSaveInstanceState(Bundle outState) {
        ...
        outState.putString(SEARCH_RESYLTS_RAW_JSON, rawJsonSearchResults);
    }
}